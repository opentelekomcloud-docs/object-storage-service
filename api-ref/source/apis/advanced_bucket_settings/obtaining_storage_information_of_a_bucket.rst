...
.. note::
   ...
   OBS bucket storage statistics are calculated in the background and are not updated in real time. Therefore, we do not recommend using storage data for real-time verification or monitoring purposes, as slight delays or inconsistencies may occur.
