...
otcdocs_doc_link = '/object-storage-service/permissions-configuration-guide/'
otcdocs_doc_title = 'Permissions Configuration Guide'
otcdocs_doc_type = 'permissions-configuration-guide'
...
latex_documents = [
    ('index',
     'obs-permissions-configuration-guide.tex',
